...
#' 
#' @description A sphere of radius R is drawn around each specified location. The number of
#' revisits is calculated as the number of segments of the trajectory passing through that sphere. 
#'  
#' @details For specified location, a sphere of radius R is drawn around that point. This method differs 
